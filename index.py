...
def De_Amt(accnt,name):
	...
	debitwn.configure(bg="green")
	fr1=tk.Frame(debitwn,bg="blue")
	l_title=tk.Message(debitwn,text="CITBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="CITBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("CIT Bank-"+name)
	rootwn.configure(background='green')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="CITBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="CTBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	crwn.configure(bg="green")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text="CITBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn=tk.Tk()
	rootwn.geometry("1600x500")
	rootwn.title("CTBanking System")
	rootwn.configure(background='green')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	bg_image = tk.PhotoImage(file ="pile1.gif")
	l_title=tk.Message(text="CITBank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="yellow",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
